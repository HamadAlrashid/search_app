...
class Preprocessor:
    ...
    def extract_text_from_pdf_docling(self, pdf_path: str) -> List[Document]:
        """
        Extract text from PDF using Docling.
        """
        pass

    def count_overlapping_terms(self, context: str, answer: str) -> int:
        """
        Calculates the number of overlapping terms between two strings.
        Args:
            context: A string containing the retrieved documents/context for the LLM.
            answer: A string containing the final answer generated by the LLM.
        Returns:
            An integer representing the number of unique overlapping words.
        """
